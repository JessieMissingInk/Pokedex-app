<template>
    <header class="bg-gradient-to-r from-green-800 to-green-600 flex md:justify-between md:flex-row flex-col w-full h-16 py-2 px-6 md:items-center overflow-hidden">
        <div>
